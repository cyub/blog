...
![观测数据点](https://static.cyub.vip/images/202606/ols_02_line.png)
...
![每一个点到直线的垂直距离叫做残差，这里以拟合结果是一条水平直线做示例](https://static.cyub.vip/images/202606/ols_04_square.png)
...
![所有残差平方求和，得到RSS，这里以拟合结果是一条水平直线做示例](https://static.cyub.vip/images/202606/ols_06_optimize_start.png)
...
![每个数据点到直线的垂直距离被画成一个正方形，正方形的面积 = 残差²。OLS 等价于最小化所有正方形的总面积——直观上就是"让所有方块尽量小"](https://static.cyub.vip/images/202606/ols_05_rss.png)
...
![从一条初始水平直线出发，不断调整 $(\beta_0, \beta_1)$ 让所有正方形面积之和（RSS）下降——右侧面板的 RSS 数字一路减小，直到无法再降，就到达了上一节公式算出的 $\hat{\boldsymbol{\beta}}$](https://static.cyub.vip/images/202606/ols_07_optimize_mid.png)
