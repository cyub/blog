...
> 本文转载自 Kimi 官方文档[入门指南：Prompt 最佳实践](https://platform.moonshot.cn/docs/guide/prompt-best-practice)一文。
...
??? note "大模型中 system prompt指的是什么，为什么它很重要？"
